...
def list_products():
    ...
    if name:
        ...
        available_value = available.lower() in ["true", "1"]
...
def update_product(product_id):
    """
    Update a Product
    This endpoint will update a Product based on the provided data
    """
    ...
    app.logger.info("Product with id [%s] updated successfully", product_id)
    return product.serialize(), status.HTTP_200_OK
